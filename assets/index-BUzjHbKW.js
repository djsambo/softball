(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))o(r);new MutationObserver(r=>{for(const s of r)if(s.type==="childList")for(const i of s.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&o(i)}).observe(document,{childList:!0,subtree:!0});function t(r){const s={};return r.integrity&&(s.integrity=r.integrity),r.referrerPolicy&&(s.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?s.credentials="include":r.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function o(r){if(r.ep)return;r.ep=!0;const s=t(r);fetch(r.href,s)}})();const E=[{id:"halcones",name:"HALCONES",manager:"Maximo Morel",stats:{pos:1,jj:1,jg:1,jp:0,avg:".1000",dif:"0"}},{id:"veteranos",name:"VETERANOS",manager:"Jhonnathan Agramonte",stats:{pos:2,jj:1,jg:1,jp:0,avg:".1000",dif:"0"}},{id:"tumba",name:"TUMBA GOBIERNO",manager:"Luis Mendez",stats:{pos:3,jj:1,jg:0,jp:1,avg:".0",dif:"1"}},{id:"leyenda",name:"LEYENDA",manager:"Emilio Estrella",stats:{pos:4,jj:1,jg:0,jp:1,avg:".0",dif:"1"}}],O={halcones:{pitchers:[{name:"Julio Venezuela",number:"-"},{name:"Yorki Tiburcio",number:"-"},{name:"Nehemias Valdez",number:"-"}],infielders:[{name:"Jeffry estrella",number:"-"},{name:"Yomelvis Grullón",number:"-"},{name:"Carlos Batista",number:"-"},{name:"Manuel Garces",number:"-"},{name:"Leudy brito",number:"-"},{name:"Dario de la Cruz",number:"-"},{name:"Rayner Grullón",number:"-"},{name:"Maximo Morel",number:"-"},{name:"Willy Ogando",number:"-"},{name:"Jordan Peralta",number:"-"},{name:"Joan Codio",number:"-"},{name:"Luis Mena",number:"-"},{name:"Yael Sierra",number:"-"},{name:"Natiel de Jesus",number:"-"},{name:"Jose Luciano",number:"-"},{name:"Gilberto Figueroa",number:"-"},{name:"Manuel Vasquez",number:"-"},{name:"Carlos acosta (hermano de Fausto)",number:"-"}]},tumba:{pitchers:[{name:"Mercedez Zuldo",number:"-"},{name:"Adrian de lo Santos",number:"-"},{name:"Juan Albuez",number:"-"}],infielders:[{name:"Daniel Javier",number:"-"},{name:"Gabriel Lebron",number:"-"},{name:"Elvis Duran",number:"-"},{name:"Domingo Berroa",number:"-"},{name:"Jose Luis (Julian Yan)",number:"-"},{name:"Luis Javier Montilla",number:"-"},{name:"Roberto Tejeda",number:"-"},{name:"Reinaldo Bodden",number:"-"},{name:"Alfredo Collado",number:"-"},{name:"Darrys Blanco",number:"-"},{name:"Julio Lopez ",number:"-"},{name:"Luis Mendez",number:"-"},{name:"Henry Gomera",number:"-"},{name:"Amaury Montas",number:"-"},{name:"Albert Ramirez",number:"-"},{name:"Joel Silverio (Altuve)",number:"-"},{name:"Yoan Martinez",number:"-"},{name:"Hugo de los Santos",number:"-"},{name:"Esquender javier (Mangu)",number:"-"}]},veteranos:{pitchers:[{name:"Yobanni Jombita",number:"-"},{name:"Martin Almonte",number:"-"},{name:"Diogenes Caribe",number:"-"}],infielders:[{name:"Daniel Ruiz",number:"-"},{name:"Edison Zapata",number:"-"},{name:"Emilio Pichardo",number:"-"},{name:"Emmanuel Vasquez",number:"-"},{name:"Jhonnathan Agramonte",number:"-"},{name:"Fausto Acosta",number:"-"},{name:"Miguel Ángel (pelotero)",number:"-"},{name:"Carlos Ureña",number:"-"},{name:"Paulino Francisco",number:"-"},{name:"Kelvin Castillo",number:"-"},{name:"Willy Perez",number:"-"},{name:"Eudy Ortiz",number:"-"},{name:"Brian Guerrero",number:"-"},{name:"Francisco Amparo",number:"-"},{name:"Luis Enrrique Reyes",number:"-"},{name:"Julian Aquino",number:"-"},{name:"Sergio Rodriguez",number:"-"},{name:"Estarlin Abad",number:"-"},{name:"Hylen Fabian ",number:"-"}]},leyenda:{pitchers:[{name:"Miguel Chavarria",number:"-"},{name:"Santos  Santana",number:"-"},{name:"Carlos Toribio",number:"-"}],infielders:[{name:"Erie Escorbores",number:"-"},{name:"Day Feliz",number:"-"},{name:"Frank Báez",number:"-"},{name:"Joel Arias",number:"-"},{name:"Emilio Estrella",number:"-"},{name:"Enmanuel Molina",number:"-"},{name:"Juan Carlos Doñe",number:"-"},{name:"Victor Concepciȯn",number:"-"},{name:"Hector de los Santos",number:"-"},{name:"Rael Capellan",number:"-"},{name:"Domingo Sambo",number:"-"},{name:"Yandry Montas",number:"-"},{name:"Emmanuel Fernandez",number:"-"},{name:"Nehemias García",number:"-"},{name:"Harold tapia",number:"-"},{name:"Fernand Acosta",number:"-"},{name:"Javier Ramirez",number:"-"},{name:"Luinny Brito (Ozutochi)",number:"-"},{name:"Josué Perdomo",number:"-"}]}},h=[{date:"MAYO 14",dateIso:"2026-05-14",subtitle:"2 Juegos de 8 Inning",games:[{time:"1er Juego 6:00pm",team1:"HALCONES",team2:"LEYENDA",status:"Finalizado",score:"18 - 6"},{time:"2do Juego",team1:"VETERANOS",team2:"TUMBA GOBIERNO",status:"Finalizado",score:"17 - 2"}]},{date:"MAYO 21",dateIso:"2026-05-21",subtitle:"Descansa: LEYENDA",games:[{time:"1er Juego 6:30pm",team1:"VETERANOS",team2:"HALCONES",status:"Próximo",score:null},{time:"2do Juego",team1:"TUMBA GOBIERNO",team2:"Ganador 1er juego",status:"Próximo",score:null},{time:"3er Juego",team1:"perdedor 1er juego",team2:"TUMBA GOBIERNO",status:"Próximo",score:null}]},{date:"MAYO 28",dateIso:"2026-05-28",subtitle:"Descansa: VETERANOS",games:[{time:"1er Juego 6:30pm",team1:"HALCONES",team2:"TUMBA GOBIERNO",status:"Próximo",score:null},{time:"2do Juego",team1:"LEYENDA",team2:"Ganador 1er juego",status:"Próximo",score:null},{time:"3er Juego",team1:"perdedor 1er juego",team2:"LEYENDA",status:"Próximo",score:null}]},{date:"JUNIO 04",dateIso:"2026-06-04",subtitle:"Descansa: HALCONES",games:[{time:"1er Juego 6:30pm",team1:"TUMBA GOBIERNO",team2:"LEYENDA",status:"Próximo",score:null},{time:"2do Juego",team1:"VETERANOS",team2:"Ganador 1er juego",status:"Próximo",score:null},{time:"3er Juego",team1:"perdedor 1er juego",team2:"VETERANOS",status:"Próximo",score:null}]},{date:"JUNIO 11",dateIso:"2026-06-11",subtitle:"Descansa: TUMBA GOBIERNO",games:[{time:"1er Juego 6:30pm",team1:"LEYENDA",team2:"VETERANOS",status:"Próximo",score:null},{time:"2do Juego",team1:"HALCONES",team2:"Ganador 1er juego",status:"Próximo",score:null},{time:"3er Juego",team1:"perdedor 1er juego",team2:"HALCONES",status:"Próximo",score:null}]},{date:"JUNIO 18",dateIso:"2026-06-18",subtitle:"Descansa: VETERANOS",games:[{time:"1er Juego 6:30pm",team1:"TUMBA GOBIERNO",team2:"HALCONES",status:"Próximo",score:null},{time:"2do Juego",team1:"LEYENDA",team2:"Ganador 1er juego",status:"Próximo",score:null},{time:"3er Juego",team1:"perdedor 1er juego",team2:"LEYENDA",status:"Próximo",score:null}]},{date:"JUNIO 25",dateIso:"2026-06-25",subtitle:"Descansa: LEYENDA",games:[{time:"1er Juego 6:30pm",team1:"HALCONES",team2:"VETERANOS",status:"Próximo",score:null},{time:"2do Juego",team1:"TUMBA GOBIERNO",team2:"Ganador 1er juego",status:"Próximo",score:null},{time:"3er Juego",team1:"perdedor 1er juego",team2:"TUMBA GOBIERNO",status:"Próximo",score:null}]},{date:"JULIO 02",dateIso:"2026-07-02",subtitle:"Descansa: HALCONES",games:[{time:"1er Juego 6:30pm",team1:"LEYENDA",team2:"TUMBA GOBIERNO",status:"Próximo",score:null},{time:"2do Juego",team1:"VETERANOS",team2:"Ganador 1er juego",status:"Próximo",score:null},{time:"3er Juego",team1:"perdedor 1er juego",team2:"VETERANOS",status:"Próximo",score:null}]},{date:"JULIO 09",dateIso:"2026-07-09",subtitle:"Descansa: TUMBA GOBIERNO",games:[{time:"1er Juego 6:30pm",team1:"VETERANOS",team2:"LEYENDA",status:"Próximo",score:null},{time:"2do Juego",team1:"HALCONES",team2:"Ganador 1er juego",status:"Próximo",score:null},{time:"3er Juego",team1:"perdedor 1er juego",team2:"HALCONES",status:"Próximo",score:null}]},{date:"JULIO 16",dateIso:"2026-07-16",subtitle:"Descansa: VETERANOS",games:[{time:"1er Juego 6:30pm",team1:"HALCONES",team2:"TUMBA GOBIERNO",status:"Próximo",score:null},{time:"2do Juego",team1:"LEYENDA",team2:"Ganador 1er juego",status:"Próximo",score:null},{time:"3er Juego",team1:"perdedor 1er juego",team2:"LEYENDA",status:"Próximo",score:null}]},{date:"JULIO 23",dateIso:"2026-07-23",subtitle:"Descansa: LEYENDA",games:[{time:"1er Juego 6:30pm",team1:"VETERANOS",team2:"HALCONES",status:"Próximo",score:null},{time:"2do Juego",team1:"TUMBA GOBIERNO",team2:"Ganador 1er juego",status:"Próximo",score:null},{time:"3er Juego",team1:"perdedor 1er juego",team2:"TUMBA GOBIERNO",status:"Próximo",score:null}]},{date:"JULIO 30",dateIso:"2026-07-30",subtitle:"Descansa: HALCONES",games:[{time:"1er Juego 6:30pm",team1:"TUMBA GOBIERNO",team2:"LEYENDA",status:"Próximo",score:null},{time:"2do Juego",team1:"VETERANOS",team2:"Ganador 1er juego",status:"Próximo",score:null},{time:"3er Juego",team1:"perdedor 1er juego",team2:"VETERANOS",status:"Próximo",score:null}]},{date:"AGOSTO 06",dateIso:"2026-08-06",subtitle:"Descansa: TUMBA GOBIERNO",games:[{time:"1er Juego 6:30pm",team1:"LEYENDA",team2:"VETERANOS",status:"Próximo",score:null},{time:"2do Juego",team1:"HALCONES",team2:"Ganador 1er juego",status:"Próximo",score:null},{time:"3er Juego",team1:"perdedor 1er juego",team2:"HALCONES",status:"Próximo",score:null}]},{date:"AGOSTO 13",dateIso:"2026-08-13",subtitle:"Descansa: VETERANOS",games:[{time:"1er Juego 6:30pm",team1:"HALCONES",team2:"TUMBA GOBIERNO",status:"Próximo",score:null},{time:"2do Juego",team1:"LEYENDA",team2:"Ganador 1er juego",status:"Próximo",score:null},{time:"3er Juego",team1:"perdedor 1er juego",team2:"LEYENDA",status:"Próximo",score:null}]},{date:"AGOSTO 20",dateIso:"2026-08-20",subtitle:"Descansa: LEYENDA",games:[{time:"1er Juego 6:30pm",team1:"VETERANOS",team2:"HALCONES",status:"Próximo",score:null},{time:"2do Juego",team1:"TUMBA GOBIERNO",team2:"Ganador 1er juego",status:"Próximo",score:null},{time:"3er Juego",team1:"perdedor 1er juego",team2:"TUMBA GOBIERNO",status:"Próximo",score:null}]},{date:"AGOSTO 27",dateIso:"2026-08-27",subtitle:"Descansa: HALCONES",games:[{time:"1er Juego 6:30pm",team1:"TUMBA GOBIERNO",team2:"LEYENDA",status:"Próximo",score:null},{time:"2do Juego",team1:"VETERANOS",team2:"Ganador 1er juego",status:"Próximo",score:null},{time:"3er Juego",team1:"perdedor 1er juego",team2:"VETERANOS",status:"Próximo",score:null}]},{date:"SEPTIEMBRE 03",dateIso:"2026-09-03",subtitle:"Descansa: TUMBA GOBIERNO",games:[{time:"1er Juego 6:30pm",team1:"LEYENDA",team2:"VETERANOS",status:"Próximo",score:null},{time:"2do Juego",team1:"HALCONES",team2:"Ganador 1er juego",status:"Próximo",score:null},{time:"3er Juego",team1:"perdedor 1er juego",team2:"HALCONES",status:"Próximo",score:null}]},{date:"SERIE SEMI FINAL NOVIEMBRE 12",dateIso:"2026-11-12",subtitle:"TRIANGULARES DE 5 INNING",games:[{time:"1er Juego 6:30pm",team1:"",team2:"",status:"Próximo",score:null},{time:"2do Juego",team1:"",team2:"",status:"Próximo",score:null},{time:"3er Juego",team1:"",team2:"",status:"Próximo",score:null}]},{date:"SERIE FINAL NOVIEMBRE 19",dateIso:"2026-11-19",subtitle:"TRIANGULARES DE 5 INNING",games:[{time:"1er Juego 6:30pm",team1:"",team2:"",status:"Próximo",score:null},{time:"2do Juego",team1:"",team2:"",status:"Próximo",score:null},{time:"3er Juego",team1:"",team2:"",status:"Próximo",score:null}]}];let c="halcones",g=!1,l=!1;const f=document.getElementById("root");function y(){const a=window.location.hash.replace("#","");return["calendario","posiciones","equipos","reglamentos"].includes(a)?a:"reglamentos"}window.addEventListener("hashchange",()=>{g=!1,d()});function N(){const a=y(),e=document.createElement("header");e.className="border-b border-white/10 sticky top-0 z-50",e.style.backgroundColor="#012169",e.innerHTML=`
    ...
    <!-- Mobile Nav Dropdown -->
    <div id="mobile-menu" class="${g?"flex":"hidden"} md:hidden flex-col bg-[#012169] border-t border-white/10 px-4 py-4 gap-4">
  ...
  `;const t=e.querySelector("#mobile-menu-toggle");return t&&t.addEventListener("click",()=>{g=!g,d()}),e}function p(a,e){const t=document.createElement("section");return t.className="mb-12",t.innerHTML=`
  ...
  `,t}function v(a){const e=document.createElement("section");return e.innerHTML=`
  ...
  `,e}function w(){const a=document.createElement("div");a.className="flex flex-col gap-12";const e=new Date,t=e.getFullYear(),o=String(e.getMonth()+1).padStart(2,"0"),r=String(e.getDate()).padStart(2,"0"),s=`${t}-${o}-${r}`,i=h.filter(n=>n.dateIso<s),j=h.filter(n=>n.dateIso>=s);if(i.length>0){const n=document.createElement("div");n.className="flex flex-col items-center gap-6";const m=document.createElement("button");if(m.className="px-6 py-3 bg-gray-200 hover:bg-gray-300 text-blue-900 font-bold uppercase rounded-lg transition-all flex items-center gap-3 active:scale-95 shadow-sm cursor-pointer",m.innerHTML=`
    ...
    `,m.addEventListener("click",()=>{l=!l,d()}),n.appendChild(m),a.appendChild(n),l){const x=document.createElement("div");x.className="space-y-12 opacity-70 grayscale-[0.3]",i.forEach(A=>{x.appendChild(v(A))}),a.insertBefore(x,n)}}const u=document.createElement("div");u.className="space-y-12";const b=document.createElement("h2");return b.className="text-3xl font-bold uppercase border-b-4 border-blue-900 pb-4 text-blue-900",b.textContent="Próximos Juegos",u.appendChild(b),j.forEach(n=>{u.appendChild(v(n))}),a.appendChild(u),a}function L(){const a=document.createElement("div");return a.className="w-full",a.innerHTML=`
  ...
  `,a}function S(){const a=document.createElement("div");a.className="flex flex-col md:flex-row gap-8";const e=E.find(o=>o.id===c),t=O[c];return a.innerHTML=`
    <!-- Sidebar -->
  ...
  `,a.querySelectorAll(".team-btn").forEach(o=>{o.addEventListener("click",()=>{c=o.getAttribute("data-team"),d()})}),a}function q(){const a=document.createElement("div");return a.className="w-full bg-white border border-gray-200 rounded-lg shadow-md p-8 md:p-12",a.innerHTML=`
...
deberá exceder los quince (15) minutos posteriores a la hora oficial programada.</li>
  ...
  `,a}function d(){const a=y();f.innerHTML="",f.appendChild(N());const e=document.createElement("main");e.className="max-w-7xl mx-auto px-4 md:px-10 py-12",a==="calendario"?(e.appendChild(p("Calendario","SERIE REGULAR 2026")),e.appendChild(w())):a==="posiciones"?(e.appendChild(p("Posiciones","SERIE REGULAR 2026")),e.appendChild(L())):a==="equipos"?(e.appendChild(p("Equipos","SERIE REGULAR 2026")),e.appendChild(S())):a==="reglamentos"&&(e.appendChild(p("Reglamentos","TEMPORADA 2026")),e.appendChild(q())),f.appendChild(e),window.scrollTo(0,0)}d();
